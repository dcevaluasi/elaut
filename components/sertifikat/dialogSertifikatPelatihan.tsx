...
import { generatedDescriptionCertificate, generatedDescriptionCertificateFull, generatedSignedCertificate, generatedStatusCertificate } from "@/utils/certificates";
                                                ...
                                                <div className={`flex flex-col items-center justify-center text-center ${peserta?.Foto == "https://elaut-bppsdm.kkp.go.id/api-elaut/public/static/profile/fotoProfile/" ? "w-[120%]" : "w-[120%]"} mt-2 space-y-1 -ml-10`}>
                                                    <div className="flex flex-col items-center gap-0.5 font-bosNormal text-sm leading-tight">
                                                        ...
                                                        <span className="leading-tight font-bosItalic text-sm">
                                                            Director General of The Agency for Marine and Fisheries Extension
                        ...
                        >
                            ...
                            <div ref={refPage} className={`pdf-page w-full flex flex-col  gap-4 relative  items-center justify-center h-[49.63rem]`}>
                                ...
                                <div className="w-full flex flex-col space-y-0 px-10 mt-10 ">
                                    ...
                                    <>
                                        {
                                            pelatihan?.JenisPelatihan != "Kerja Sama" ? <div className="flex w-full flex-col space-y-1 max-w-7xl mx-auto items-start text-sm -mt-2 text-center font-bos h-fit">
                                                <span className="text-lg leading-[115%] font-bosNormal max-w-7xl">
                                            ...
                                            </div> : <div className="flex w-full flex-col space-y-1 max-w-7xl mx-auto items-start text-sm -mt-2 text-center font-bos h-fit">
                                                <span className="text-lg leading-[115%] font-bosNormal max-w-7xl">
                                                    {generatedDescriptionCertificateFull(dataProgramPelatihan[0]?.description).body_indo}
                                                </span>
                                                {
                                                    generatedDescriptionCertificateFull(dataProgramPelatihan[0]?.description).body_eng != "" && <span className="max-w-6xl mt-1 leading-none font-bosItalic text-[0.9rem] mx-auto">
                                                        {generatedDescriptionCertificateFull(dataProgramPelatihan[0]?.description).body_eng}
                                                    </span>
                                                }
                                        ...
                                        <div className="flex gap-2 items-center justify-center pt-4">
                                            <div className="grid grid-cols-3 items-center">
                                                ...
                                                {/* Kolom 3 - Tanda Tangan & Pejabat */}
                                                <div className={`flex flex-col items-center justify-center text-center ${peserta?.Foto == "https://elaut-bppsdm.kkp.go.id/api-elaut/public/static/profile/fotoProfile/" ? "w-[120%] -ml-10" : "w-[120%] -ml-16"} mt-2 space-y-1 `}>
                                                    <div className="flex flex-col items-center gap-0.5 font-bosNormal text-sm leading-tight">
