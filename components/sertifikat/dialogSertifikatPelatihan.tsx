      ...
      <div className=" flex-col gap-8 font-bos">
        ...
        >
          ...
          {pelatihan?.TtdSertifikat == ESELON2 &&
            <>
              <div ref={refPage} className={`pdf-page w-full flex flex-col  gap-4 relative  items-center justify-center ${userPelatihan!.IsActice.includes("SEBAGAI") ? "h-[53rem] " : "h-[49.63rem]"}`}>
                <div className="flex flex-row  absolute top-0 right-0">
                  <p className="text-lg font-bosNormal">
                    No. STTPL : {userPelatihan?.NoRegistrasi}
                  </p>
