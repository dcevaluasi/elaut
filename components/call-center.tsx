...
function CallCenter() {
  ...
  return (
    <div className={`${usePathname().includes('lemdiklat') || usePathname().includes('pusat') || usePathname().includes('instruktur/form') ? 'hidden' : 'flex'} flex-col gap-3 w-fit fixed right-3 md:right-10 bottom-24 md:bottom-10 z-[999999999]`}>
