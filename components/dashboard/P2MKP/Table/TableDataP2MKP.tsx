...
import {
    Building2, Users, MapPin, Search, ChevronLeft, ChevronRight,
    ArrowUpRight, Settings, ShieldCheck, Activity, Briefcase,
    TrendingUp, Award, Phone, Mail, FileText
} from "lucide-react";
...
const TableDataP2MKP = () => {
    ...
    const filteredData = useMemo(() => {
        ...
        return p2mkpData.filter((row) => {
            const matchesStatus = (row.status || "").toLowerCase() === "telah ditetapkan";
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-6 text-right">
                                            <div className="flex flex-col gap-2 items-end">
                                                ...
                                                <button
                                                    className="flex items-center gap-1.5 text-[9px] font-black text-slate-400 hover:text-blue-600 transition-colors uppercase tracking-widest mr-2"
                                                >
                                                    <FileText size={10} />
                                                    Dokumen
                                                </button>
