    ...
    return (
        ...
        `,
                ...
                <div className="flex w-full flex-col items-start">
                    ...
                    {/* Instruktur/Pelatih */}
                    <AccordionSection title="🧩 Instruktur atau Pelatih" description={<small className="my-2 pb-4 text-sm text-slate-600 antialiased">Dalam proses ini <b>diwajibkan</b> memilih instruktur/pelatih yang akan mengajar dalam pelaksanaan pelatihan, apabila data instruktur yang dimaksud tidak tertera maka dapat diabaikan untuk pengisian data instruktur/pelatih.</small>
                    }>
                    ...
                    {
                        parseInt(data?.StatusPenerbitan) < 5 &&
                        <AccordionSection title="👥 Peserta Pelatihan" description={<small className="my-2 pb-4 text-sm text-slate-600 antialiased">Dalam proses ini, data peserta pelatihan dapat dihasilkan dari dua jalur yakni pendaftaran mandiri peserta (dengan catatan informasi pelatihan telah dipublish di wesite e-laut) dan melalui import file yang berisikan data peserta dengan mengklik tombol <b>Import Data Peserta</b>, dalam hal import hanya dapat dilakukan sekali!</small>}>
                            <div className="flex flex-col w-full gap-4">
                                <div className="w-full flex items-center gap-2 pb-4 border-b border-b-gray-200">
                                    <p className="font-medium text-gray-600">
                                        Action :
