    ...
    },
    {
      ...
      header: ({ column }) => {
        return (
          ...
          >
            Detail Konsumsi
            <MdOutlineFastfood className="ml-2 h-4 w-4" />
          </Button>
        );
      },
      cell: ({ row }) => (
            ...
            <div className="flex min-w-47.5">
              ...
              <div className="w-full">
                <p className="font-semibold text-primary">
                  Total Jenis Konsumsi
                </p>
                <p className="text-sm font-medium">{data.length} paket</p>
              </div>
            </div>
          </div>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="-mt-2">
                    Daftarkan paket konsumsi di lemdiklat/balai mu sebagai
                  ...
                  <div className="w-full mb-1 flex">
                    <div className="w-full">
                      ...
                      <label
                        ...
                        htmlFor="name"
                      >
                        Foto Konsumsi <span className="text-red-600">*</span>
                      </label>
                      <input
                        type="file"
