...
const TableDataBlankoKeluarPublic: React.FC = () => {
  ...
  const handleFetchingBlanko = async () => {
    ...
    try {
      const response: AxiosResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_BLANKO_AKAPI_URL}/adminpusat/getBlankoKeluar?tipe_blanko=Certificate of Competence (CoC)`
      );
...
export default TableDataBlankoKeluarPublic;
