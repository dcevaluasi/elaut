...
> = {
  HACCP: {
    ...
    desc_eng:
      'In the Hazard Analysis and Critical Control Points (HACCP) Training, which was organized in collaboration between the Maritime and Fisheries Training Center - Maritime and Fisheries Human Resource Development and Extension Agency, and the Postharvest Quality Control and Supervision Center - Marine and Fisheries Products Quality Control and Supervision Agency on',
  },
  CBIB: {
    desc_ind:
  ...
  CPIB: {
    ...
    desc_eng:
      'In the Training on Good Fish Hatchery Methods which was held in collaboration between the Maritime and Fisheries Training Center - Maritime and Fisheries Human Resource Development and Extension Agency, the Directorate of Seaweed - Directorate General of Fisheries Cultivation, and the Center for Control and Primary Production Quality Control and Supervision - Marine and Fisheries Quality Control and Supervision Agency on',
  },
  CPPIB: {
    desc_ind:
