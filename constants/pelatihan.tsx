...
export const BALAI_PELATIHAN: BalaiPelatihan[] = [
  {
    ...
    Name: "Balai Pelatihan dan Penyuluhan Perikanan (BPPP) Tegal",
    Location: "tegal",
  ...
  },
  {
    ...
    Name: "Balai Pelatihan dan Penyuluhan Perikanan (BPPP) Ambon",
    Location: "ambon",
  ...
  },
  {
    ...
    Name: "Balai Pelatihan dan Penyuluhan Perikanan (BPPP) Banyuwangi",
    Location: "banyuwangi",
  ...
  },
  {
    ...
    Name: "Balai Pelatihan dan Penyuluhan Perikanan (BPPP) Bitung",
    Location: "bitung",
  ...
  },
  {
    ...
    Name: "Balai Pelatihan dan Penyuluhan Perikanan (BPPP) Medan",
    Location: "medan",
...
export const SATUAN_PENDIDIKAN: BalaiPelatihan[] = [
  {
    Id: "BP001",
    Longitude: 109.15246944603237,
    Latitude: -6.854096593757315,
...
export const SATUAN_PENDIDIKAN_KEAHLIAN: BalaiPelatihan[] = [
  {
    Id: "BP001",
    Longitude: 106.83592402245853,
    Latitude: -6.29364700275255,
    Name: "Politeknik AUP Jakarta",
    Location: "Jakarta",
    Description: "Politeknik AUP Jakarta.",
    FullName: "Politeknik AUP",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_1.jpg",
  },
  {
    Id: "BP002",
    Longitude: 112.79000349733717,
    Latitude: -7.397278801799742,
    Name: "Politeknik KP Sidoarjo",
    Location: "Sidoarjo",
    Description: "Politeknik Kelautan dan Perikanan Sidoarjo.",
    FullName: "Politeknik KP Sidoarjo",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_2.jpg",
  },
  {
    Id: "BP003",
    Longitude: 125.21365397582687,
    Latitude: 1.4593917042343285,
    Name: "Politeknik KP Bitung",
    Location: "Bitung",
    Description: "Politeknik Kelautan dan Perikanan Bitung.",
    FullName: "Politeknik KP Bitung",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_3.jpg",
  },
  {
    Id: "BP004",
    Longitude: 131.23524670467114,
    Latitude: -0.8288244208613316,
    Name: "Politeknik KP Sorong",
    Location: "Sorong",
    Description: "Politeknik Kelautan dan Perikanan Sorong.",
    FullName: "Politeknik KP Sorong",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_4.jpg",
  },
  {
    Id: "BP005",
    Longitude: 107.3034991684864,
    Latitude: -6.283688713044108,
    Name: "Politeknik KP Karawang",
    Location: "Karawang",
    Description: "Politeknik Kelautan dan Perikanan Karawang.",
    FullName: "Politeknik KP Karawang",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_5.jpg",
  },
  {
    Id: "BP006",
    Longitude: 120.38023080709479,
    Latitude: -4.478478838639347,
    Name: "Politeknik KP Bone",
    Location: "Bone",
    Description: "Politeknik Kelautan dan Perikanan Bone.",
    FullName: "Politeknik KP Bone",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_6.jpg",
  },
  {
    Id: "BP007",
    Longitude: 123.51261228388972,
    Latitude: -10.222068919145048,
    Name: "Politeknik KP Kupang",
    Location: "Kupang",
    Description: "Politeknik Kelautan dan Perikanan Kupang.",
    FullName: "Politeknik KP Kupang",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_7.jpg",
  },
  {
    Id: "BP008",
    Longitude: 101.41424663215554,
    Latitude: 1.693668563937888,
    Name: "Politeknik KP Dumai",
    Location: "Dumai",
    Description: "Politeknik Kelautan dan Perikanan Dumai.",
    FullName: "Politeknik KP Dumai",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_8.jpg",
  },
  {
    Id: "BP009",
    Longitude: 108.68252424151959,
    Latitude: -7.678974242072445,
    Name: "Politeknik KP Pangandaran",
    Location: "Pangandaran",
    Description: "Politeknik Kelautan dan Perikanan Pangandaran.",
    FullName: "Politeknik KP Pangandaran",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_9.jpg",
  },
  {
    Id: "BP010",
    Longitude: 114.57901379865604,
    Latitude: -8.390532523667353,
    Name: "Politeknik KP Jembrana",
    Location: "Jembrana",
    Description: "Politeknik Kelautan dan Perikanan Jembrana.",
    FullName: "Politeknik KP Jembrana",
    KepalaBalaiPelatihan: "",
  ...
  },
  {
    ...
    Longitude: 114.57901379865604,
    Latitude: -8.390532523667353,
    Name: "SUPM Kota Agung",
    Location: "Jembrana",
    Description: "Politeknik Kelautan dan Perikanan Jembrana.",
    FullName: "SUPM Kota Agung",
    KepalaBalaiPelatihan: "",
    Image: "link_to_image_10.jpg",
  },
];
