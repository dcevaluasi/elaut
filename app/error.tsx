                ...
                >
                    ...
                    <div className="space-y-1">
                        ...
                        >
                            ...
                            <span className="text-rose-400 text-xs font-bold uppercase">Gateway Interruption</span>
                            <span className="h-px w-8 bg-rose-500/50" />
                        </motion.div>
                    ...
                    >
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={() => reset()}
                            className="group flex items-center gap-3 px-8 py-4 bg-rose-600 hover:bg-rose-500 text-white rounded-2xl font-bold shadow-2xl shadow-rose-500/20 transition-all border-none"
                        >
                    ...
                    >
                        <div className="flex items-center justify-center gap-2 text-[10px] font-jakarta hover:text-gray-400 transition-colors">
