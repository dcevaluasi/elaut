    ...
    return (
        <DashboardLayout>
            <div className="relative overflow-hidden bg-slate-50 min-h-screen">
                ...
                <div className="absolute bottom-1/2 left-0 w-[400px] h-[400px] bg-indigo-100/50 rounded-full blur-[100px] pointer-events-none" />
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">Status Kepemilikan</FormLabel>
                                                <Select onValueChange={field.onChange} value={field.value}>
                                                    <FormControl>
                                                        <SelectTrigger className="w-full h-14 bg-white border border-slate-200 rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-slate-700 hover:border-slate-300 shadow-sm">
                                                    ...
                                                    <SelectContent className="bg-white border-slate-200 text-slate-800 rounded-2xl shadow-xl">
                                                        {['Koperasi',
                                                            ...
                                                            'Perserorangan',].map(val => (
                                                                <SelectItem key={val} value={val} className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">{val}</SelectItem>
                                                            ))}
                                                    </SelectContent>
                                                </Select>
                                            </FormItem>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">Apakah Lembaga LPK?</FormLabel>
                                                <Select onValueChange={field.onChange} value={field.value}>
                                                    <FormControl>
                                                        <SelectTrigger className="w-full h-14 bg-white border border-slate-200 rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-slate-700 hover:border-slate-300 shadow-sm">
                                                    ...
                                                    <SelectContent className="bg-white border-slate-200 text-slate-800 rounded-2xl shadow-xl">
                                                        <SelectItem value="Ya" className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">Ya, Terdaftar LPK</SelectItem>
                                                        <SelectItem value="Tidak" className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">Tidak</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </FormItem>
                                        )}
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">Rumpun Utama</FormLabel>
                                                <Select
                                                    onValueChange={(val) => {
                                                        field.onChange(val);
                                                ...
                                                >
                                                    ...
                                                    <SelectContent className="bg-white border-slate-200 text-slate-800 rounded-2xl shadow-xl">
                                                        {rumpunPelatihan?.map((item: any) => (
                                                            <SelectItem key={item.id_rumpun_pelatihan} value={item.name} className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">
                                                                {item.name}
                                                            </SelectItem>
                                                        ))}
                                                    </SelectContent>
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">Jenis Kelamin</FormLabel>
                                                <Select onValueChange={field.onChange} value={field.value}>
                                                    <FormControl>
                                                        <SelectTrigger className="w-full h-14 bg-white border border-slate-200 rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-slate-700 hover:border-slate-300 shadow-sm">
                                                    ...
                                                    <SelectContent className="bg-white border-slate-200 text-slate-800 rounded-2xl shadow-xl">
                                                        <SelectItem value="Laki-laki" className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">Laki-laki</SelectItem>
                                                        <SelectItem value="Perempuan" className="hover:bg-slate-50 rounded-lg py-3 cursor-pointer focus:bg-blue-50 focus:text-blue-700">Perempuan</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1">Pendidikan Terakhir</FormLabel>
                                                <Select onValueChange={field.onChange} value={field.value}>
                                                    <FormControl>
                                                        <SelectTrigger className="w-full h-14 bg-white border border-slate-200 rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 outline-none transition-all text-slate-700 hover:border-slate-300 shadow-sm">
            ...
            <AlertDialog open={alertConfig.isOpen} onOpenChange={(open) => setAlertConfig(prev => ({ ...prev, isOpen: open }))}>
                <AlertDialogContent className="bg-white border-slate-200 text-slate-900 font-sans shadow-xl rounded-2xl">
                    ...
                    <AlertDialogFooter className="border-t border-slate-100 pt-4">
                        <AlertDialogAction className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 border-none rounded-xl">
                            MENGERTI
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
...
function FormCard({ icon, title, subtitle, children, color }: any) {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className="group p-8 md:p-12 rounded-[2rem] bg-white border border-slate-200 shadow-sm space-y-10 relative overflow-hidden transition-all duration-700 hover:border-slate-300"
        >
            <div className={`absolute top-0 right-0 p-16 opacity-[0.02] group-hover:opacity-[0.04] transition-opacity`}>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-100">
                <div className="flex items-center gap-6">
                    <div className={`w-16 h-16 rounded-[1.25rem] flex items-center justify-center text-2xl border ${colors[color]}`}>
                        {icon}
                    </div>
...
function FormFieldItem({ label, name, control, placeholder, icon, type = "text", ...props }: any) {
    return (
        <FormField
            ...
            render={({ field }) => (
                <FormItem className="space-y-2">
                    <FormLabel className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-1 flex items-center gap-2">
                        {label}
                    </FormLabel>
                    <FormControl>
                        <div className="relative group/input">
                            {icon && <span className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-blue-500 transition-all duration-300 z-10">{icon}</span>}
                            <Input
                                placeholder={placeholder}
                                type={type}
                                {...field}
                                {...props}
                                className={`w-full ${icon ? 'pl-14' : 'pl-5'} pr-5 bg-white border border-slate-200 shadow-sm rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 outline-none transition-all duration-300 text-slate-800 placeholder:text-slate-400 h-14 group-hover/input:border-slate-300`}
                            />
                        </div>
                    </FormControl>
                    <FormMessage className="text-[10px] font-bold text-rose-500 tracking-wide pl-1 mt-1" />
                </FormItem>
            )}
        />
    );
                    ...
                    <FormControl>
                        <div className="flex items-center gap-3">
                            <div className="relative group/input flex-1">
                                <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-blue-500 transition-colors z-10">
                                    {icon}
                                </div>
                                <input
                                    type="file"
                                ...
                                <label
                                    ...
                                    className={`w-full pl-12 pr-5 py-4 bg-white border border-dashed rounded-2xl text-sm transition-all cursor-pointer flex items-center h-14 overflow-hidden ${value ? 'border-blue-400 bg-blue-50 shadow-inner' : 'border-slate-300 hover:border-blue-400 hover:bg-slate-50'}`}
                                >
                                    <span className={`truncate ${value ? 'text-blue-700 font-bold' : 'text-slate-400'}`}>
                            ...
                            {typeof value === 'string' && value && (
                                <a
                                    ...
                                    className="h-14 w-14 shrink-0 bg-blue-50 border border-blue-100 rounded-2xl flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-all shadow-sm group"
