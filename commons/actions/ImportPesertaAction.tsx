        ...
        <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <AlertDialogTrigger asChild>
                <Button
                    ...
                    variant="outline"
                    className="flex items-center w-fit rounded-lg px-4 py-2 shadow-sm transition-all bg-transparent  text-green-600 hover:text-white hover:bg-green-600 border border-green-600"
                >
