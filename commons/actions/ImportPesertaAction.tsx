        ...
        <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <AlertDialogTrigger asChild>
                <Button
                    ...
                    className="flex items-center gap-2 border w-fit rounded-lg px-4 py-2 shadow-sm transition-all bg-transparent border-green-400 text-green-600 hover:text-white hover:bg-green-600"
                >
